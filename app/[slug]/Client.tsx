        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <div className="flex gap-3 mt-3">
              {event?.twitter && <a href={`https://twitter.com/${event.twitter}`} target="_blank" rel="noopener noreferrer" className="text-[var(--text-muted)] hover:text-white text-sm transition-colors">𝕏</a>}
              {event?.instagram && <a href={`https://instagram.com/${event.instagram}`} target="_blank" rel="noopener noreferrer" className="text-[var(--text-muted)] hover:text-white text-sm transition-colors">IG</a>}
              {event?.linkedin && <a href={`https://linkedin.com/company/${event.linkedin}`} target="_blank" rel="noopener noreferrer" className="text-[var(--text-muted)] hover:text-white text-sm transition-colors">LI</a>}
            </div>
          </div>
        </div>
